...
rss = RSS::Maker.make('2.0') do |maker|
  ...
  maker.channel.itunes_image = "https://#{CLOUDFRONT_DOMAIN}/photo/cover.png"

  # エピソード1
  item = maker.items.new_item
  item.title = 'エピソード1'
  item.link = "https://#{CLOUDFRONT_DOMAIN}/audio/episode1.mp3"
  item.guid.content = "https://#{CLOUDFRONT_DOMAIN}/audio/episode1.mp3"
  item.description = 'エピソード1の説明'
  item.pubDate = Time.parse('2025-06-26')
  item.enclosure.url = "https://#{CLOUDFRONT_DOMAIN}/audio/episode1.mp3"
      ...
      <div class="container">
          ...
          <div class="episode">
              ...
              <audio controls class="audio-player">
                  <source src="https://#{CLOUDFRONT_DOMAIN}/audio/episode1.mp3" type="audio/mpeg">
